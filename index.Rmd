---
title: "flexdashboard - Pajareadas  en Caldas y Quindio"
...
MyEBirdData<- read.csv("/Users/sandrarairan/Documents/Platzi/Fundamentos-R/MyEBirdData_2020.csv")
#data(MyEBirdData)
#str(MyEBirdData1)
...
Top Aves MasObservadas (2019 - 2020)
=======================================================================
Row {data-height=600}
------------------------------------------------------------------------------
### Aves observadas segun el Duration en Minutos
```{r}
TopMasVistosB <- MyEBirdData %>%
  filter(Scientific.Name %in% c( "Amazona mercenarius", "Pygochelidon cyanoleuca", "Pionus menstruus","Leptosittaca branickii",  "Columbina talpacoti", "Pionus menstruus"))

#TopMasVistosB


#install.packages("RColorBrewer")
myColor <- brewer.pal(7,"OrRd")
ggplot(TopMasVistosB, aes(x=State.Province,
                          y=Count,fill=Count))+
  geom_tile()+
